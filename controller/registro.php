<?php
    ...
    if(!empty($_POST["btnRegistrar"])){
        if(!empty($_POST["nombre"]) and !empty($_POST["apellido"]) and !empty($_POST["dni"]) and !empty($_POST["fecha"]) and !empty($_POST["correo"])){
            ...
            $sql = $conexion->query("INSERT INTO persona (nombre, apellido, dni, fechaNacimiento, correo) VALUES  ('$nombre', '$apellido', '$dni', '$fechaNacimiento', '$correo')");
            ...
            if($sql == 1){
                ...
                <div class='alert alert-success d-flex align-items-center' role='alert'>
                    ...
                    <div>Persona Registrada Correctamente</div>
                </div>";
            }else{
                echo "
                <div class='alert alert-danger d-flex align-items-center' role='alert'>
                    ...
                    <div>Error al Registrar a la Persona</div>
                </div>";
            }
            ...
            <div class='alert alert-warning d-flex align-items-center' role='alert'>
                ...
                <div>Alguno de los Campos esta Vacio</div>
            </div>";
        }
    }
